	...
	class AviaHtmlHelper 
	{
		...
		*/
		...
		static protected function critical_characters_message( array $element )
		{
			...
			$output .=		sprintf( __( 'Warning: Characters %s might break ALB backend or frontend. <a href="https://kriesi.at/documentation/enfold/intro-to-layout-builder/#using-special-characters" target="_blank" rel="noopener noreferrer">Read more</a> if you want to use them.', 'avia_framework' ), implode( ',', Avia_Builder()->critical_modal_charecters() ) );
			$output .= '</div>';
